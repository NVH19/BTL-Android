...
class RemoteDataSource() : IDataSource {
    ...
    override suspend fun getProductSuggestions(query_string: String): Response<ProductList> {
        return RetrofitClient.apiService.getProductSuggestions(query_string)
    }
